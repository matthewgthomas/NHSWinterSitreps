#' Load timeseries of winter situation reports from 2013-14
#'
#' Downloads and cleans the "Daily SR – Time series 4 November 2013 to 30 March 2014" data from https://www.england.nhs.uk/statistics/statistical-work-areas/winter-daily-sitreps/winter-daily-sitrep-2013-14-data-2/
#'
...
#'
#' @importFrom magrittr "%>%"
load_sitreps_1314 = function(sitrep_url = "https://www.england.nhs.uk/statistics/wp-content/uploads/sites/2/2013/11/DailySR-Timeseries-WE-30.03.14.xlsx") {
  ##
  ...
  sitrep_dates$Date_txt = ifelse(sitrep_dates$Date_txt == "29-Nov-13 - 01-Dec-13", "29-Nov-13", sitrep_dates$Date_txt)
  sitrep_dates$Date_txt = ifelse(sitrep_dates$Date_txt == "31-Dec-13 - 01-Jan-14", "01-Jan-14", sitrep_dates$Date_txt)
  sitrep_dates$Date_txt = ifelse(sitrep_dates$Date_txt == "31-Jan-14 - 02-Feb-14", "02-Feb-14", sitrep_dates$Date_txt)
  sitrep_dates$Date_txt = ifelse(sitrep_dates$Date_txt == "28-Feb-14 - 02-Mar-14", "02-Mar-14", sitrep_dates$Date_txt)
  ...
  sitrep_diverts$Date_txt = ifelse(sitrep_diverts$Date_txt == "29-Nov-13 - 01-Dec-13", "29-Nov-13", sitrep_diverts$Date_txt)
  sitrep_diverts$Date_txt = ifelse(sitrep_diverts$Date_txt == "31-Dec-13 - 01-Jan-14", "01-Jan-14", sitrep_diverts$Date_txt)
  sitrep_diverts$Date_txt = ifelse(sitrep_diverts$Date_txt == "31-Jan-14 - 02-Feb-14", "02-Feb-14", sitrep_diverts$Date_txt)
  sitrep_diverts$Date_txt = ifelse(sitrep_diverts$Date_txt == "28-Feb-14 - 02-Mar-14", "02-Mar-14", sitrep_diverts$Date_txt)
  ...
  sitrep_closures$Date_txt = ifelse(sitrep_closures$Date_txt == "29-Nov-13 - 01-Dec-13", "29-Nov-13", sitrep_closures$Date_txt)
  sitrep_closures$Date_txt = ifelse(sitrep_closures$Date_txt == "31-Dec-13 - 01-Jan-14", "01-Jan-14", sitrep_closures$Date_txt)
  sitrep_closures$Date_txt = ifelse(sitrep_closures$Date_txt == "31-Jan-14 - 02-Feb-14", "02-Feb-14", sitrep_closures$Date_txt)
  sitrep_closures$Date_txt = ifelse(sitrep_closures$Date_txt == "28-Feb-14 - 02-Mar-14", "02-Mar-14", sitrep_closures$Date_txt)
