#' Load timeseries of winter situation reports from 2014-15
#'
#' Downloads and cleans the "Winter SitRep Part A: Acute Time Series 03 November 2014 to 29 March 2015" data from https://www.england.nhs.uk/statistics/statistical-work-areas/winter-daily-sitreps/winter-daily-sitrep-2014-15-data/
#'
...
#'
#' @importFrom magrittr "%>%"
load_sitreps_1415 = function(sitrep_url = "https://www.england.nhs.uk/statistics/wp-content/uploads/sites/2/2014/12/DailySR-Timeseries-WE-29.03.15.xlsx") {
  ##
  ...
  sitrep_dates$Date_txt = ifelse(sitrep_dates$Date_txt == "31-Dec-14-Jan-15", "31-Dec-14", sitrep_dates$Date_txt)
  sitrep_dates$Date_txt = ifelse(sitrep_dates$Date_txt == "30-Jan-01-Feb-15", "01-Feb-15", sitrep_dates$Date_txt)
  sitrep_dates$Date_txt = ifelse(sitrep_dates$Date_txt == "27-Feb-01-Mar-15", "01-Mar-15", sitrep_dates$Date_txt)
  ...
  sitrep_diverts$Date_txt = ifelse(sitrep_diverts$Date_txt == "31-Dec-14-Jan-15", "31-Dec-14", sitrep_diverts$Date_txt)
  sitrep_diverts$Date_txt = ifelse(sitrep_diverts$Date_txt == "30-Jan-01-Feb-15", "01-Feb-15", sitrep_diverts$Date_txt)
  sitrep_diverts$Date_txt = ifelse(sitrep_diverts$Date_txt == "27-Feb-01-Mar-15", "01-Mar-15", sitrep_diverts$Date_txt)
  ...
  sitrep_closures$Date_txt = ifelse(sitrep_closures$Date_txt == "31-Dec-14-Jan-15", "31-Dec-14", sitrep_closures$Date_txt)
  sitrep_closures$Date_txt = ifelse(sitrep_closures$Date_txt == "30-Jan-01-Feb-15", "01-Feb-15", sitrep_closures$Date_txt)
  sitrep_closures$Date_txt = ifelse(sitrep_closures$Date_txt == "27-Feb-01-Mar-15", "01-Mar-15", sitrep_closures$Date_txt)
