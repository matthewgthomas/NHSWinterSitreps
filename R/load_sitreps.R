...
load_sitreps = function(winter) {
  ...
  if (winter == "2022-23") {
    ...
    sitrep = load_sitreps_2223(
      "https://www.england.nhs.uk/statistics/wp-content/uploads/sites/2/2023/02/UEC-Daily-SitRep-Web-File-Timeseries-1.xlsx",
      "https://www.england.nhs.uk/statistics/wp-content/uploads/sites/2/2023/02/Ambulance-Collection-Web-File-Timeseries-1.xlsx"
    )
