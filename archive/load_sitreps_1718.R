#' Load timeseries of winter situation reports from 2017-18
#'
#' Downloads and cleans the "Winter Sitrep: Acute Time series 20 November 2017 to 4 March 2018" data from https://www.england.nhs.uk/statistics/statistical-work-areas/winter-daily-sitreps/winter-daily-sitrep-2017-18-data/
#'
...
#'
#' @export
load_sitreps_1718 = function(sitrep_url = "https://www.england.nhs.uk/statistics/wp-content/uploads/sites/2/2018/03/Winter-data-Timeseries-20180304.xlsx") {
  ##
  ...
  sitrep_1718 = sitrep_ambo30 %>% dplyr::rename(Delays30 = Delays) %>%
  ...
  # re-order columns
  sitrep_1718 = sitrep_1718 %>% dplyr::select(Code, Name, Date, dplyr::everything())
